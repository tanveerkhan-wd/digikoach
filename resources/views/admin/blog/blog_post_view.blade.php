...
<div class="section">
  <div class="container-fluid">
    <h2 class="title"><span>{{'Master'}}</span> > <a  class="ajax_request" data-slug="admin/blog" href="{{url('/admin/blog')}}"><span>{{'Blog'}}</span></a>  >  {{'View'}}</h2>
        <div class="white_box">
            <div class="theme_tab">
                        ...
                        <div class="col-lg-6">
                            ...
                            @if(!empty($data->blog_post_desc) && $data->blog_post_desc!=null)
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name_{{$value->lang_code}}" id="name_{{$value->lang_code}}" class="form-control icon_control" value="{{$value->blog_post_title}}" disabled>
                                </div>
                                @endforeach
                            @endif
{{--                             <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control icon_control dropdown_control" name="category" id="category" disabled>
                            ...
                            @if(!empty($data->blog_post_desc) && $data->blog_post_desc!=null)
                                @foreach($data->blog_post_desc as $value)
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control icon_control" name="desc_{{$value->lang_code}}" id="desc_{{$value->lang_code}}" rows="3" disabled>{{$value->description}}</textarea>
                                    </div>
                                @endforeach
                            @endif
                            {{-- <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="seo_meta_title" id="seo_meta_title" class="form-control icon_control" value="{{$data->seo_meta_title}}" disabled>
                            </div>
                            <div class="form-group">
                                <label>{{'SEO Meta Description'}}</label>
                                <textarea class="form-control icon_control" name="seo_meta_description" id="seo_meta_description" rows="3" disabled>{{$data->seo_meta_description}}</textarea>
                            </div>

    ...
    <div class="container-fluid">
        <div class="row ">
            <div class="col-md-4 mb-3">
                <h2 class="title"><a  class="ajax_request" data-slug="admin/appUsers" href="{{url('/admin/appUsers')}}"><span>{{'App User '}}</span></a>  >  {{'View'}}</h2>
            </div>  
            ...
            <div class="col-md-2 col-6 mb-3">
                <a href="{{ url('admin/viewAppUser/') }}/{{$data['user_id']}}?type={{$data['exams_type']}}"><button class="theme_btn show_modal full_width small_btn">{{'Back'}}</button></a>
            </div>
        </div>
                                                            ...
                                                            @if($op_value['desc']['lang_code']=='en')
                                                                ...
                                                                <div class="show_que_images">
                                                                    ...
                                                                    @foreach($value['option_media'] as $media)
                                                                        ...
                                                                        <li>
                                                                            <img src="{{ url('public/storage/'.Config::get('siteglobal.images_dirs.QUESTIONS')) }}{{'/'.$media_val['media_file']}}">
                                                                        </li>
                                                                        @endif
                                                                        @endforeach
                                                                    @endforeach

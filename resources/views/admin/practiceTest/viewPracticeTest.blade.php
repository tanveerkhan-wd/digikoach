...
@section('title','View Practice Test')
    ...
    <div class="container-fluid">
        <div class="row ">
            <div class="col-md-4 mb-3">
                <h2 class="title"><a  class="ajax_request" data-slug="admin/practiceTest" href="{{url('/admin/practiceTest')}}"><span>{{'Practice Test '}}</span></a>  >  {{'View'}}</h2>
            </div>  
            ...
            <div class="col-md-2 col-6 mb-3">
                <a href="{{ url('admin/practiceTest') }}"><button class="theme_btn show_modal full_width small_btn">{{'Back'}}</button></a>
            </div>
        </div>

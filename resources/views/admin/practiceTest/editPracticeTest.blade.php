...
@section('title','Edit Practice Test')
@section('script', url('public/js/dashboard/practice_test.js'))
@section('content') 
<!-- Page Content  -->
<div class="section">
    <div class="container-fluid">
        <h2 class="title"><a  class="ajax_request" data-slug="admin/practiceTest" href="{{url('/admin/practiceTest')}}"><span>{{'Practice Test '}}</span></a>  >  {{'Edit'}}
        </h2>
        <div class="white_box">
            <div class="theme_tab">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <label>@if($exmValue['lang_code']=='en') {{'Practice Test Name In English'}} @else {{'Practice Test Name In Hindi'}} @endif </label>

	...
	<div class="container-fluid">
		...
		<div class="row ">
            ...
            <div class="col-md-2 col-6 mb-3">
                ...
                @endphp
                @if(!empty($accessPriData['Quizz_Test']) && $accessPriData['Quizz_Test']->add==true || Auth::user()->user_type==0)
                <a href="{{url('/admin/addQuizTest')}}"><button class="theme_btn show_modal full_width small_btn">{{'Add New'}}</button></a>
                @endif
            </div>
        </div>

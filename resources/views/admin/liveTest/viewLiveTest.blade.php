    ...
    <div class="container-fluid">
        <div class="row ">
            <div class="col-md-4 mb-3">
                <h2 class="title"><a  {{-- class="ajax_request" data-slug="admin/liveTest" --}} href="{{url('/admin/liveTest')}}"><span>{{'Live Test '}}</span></a>  >  {{'View'}}</h2>
            </div>  
            ...
            <div class="col-md-2 col-6 mb-3">
                <a href="{{ url('admin/liveTest') }}"><button class="theme_btn show_modal full_width small_btn">{{'Back'}}</button></a>
            </div>
        </div>
        <div class="white_box">
            <div class="theme_tab">
                ...
                <form name="add-live-test-form">
                    ...
                    <div class="row">
                        <div class="col-md-2 col-lg-2">
                            <label class="h6 live_test_lable"><b> Date: </b></label>
                        </div>
                        <div class="col-md-4 col-lg-4">
                            <label class="h6"> {{ date('d-M-Y',strtotime($getExam['exam_starts_on'])) ?? '' }} | {{ date('h:i',strtotime($getExam['exam_starts_on'])) ?? '' }} to {{ date('d-M-Y',strtotime($getExam['exam_ends_on'])) ?? '' }} | {{ date('h:i',strtotime($getExam['exam_ends_on'])) ?? '' }} </label>
                        </div>

    ...
    <div class="container-fluid">
        <div class="row ">
            <div class="col-md-4 mb-3">
                <h2 class="title"><span>{{'Gk & Ca'}} </span> > <a  class="ajax_request" data-slug="admin/gkCa/quizTest" href="{{url('/admin/gkCa/quizTest')}}"><span>{{'Quizzes'}}</span></a>  >  {{'View'}}</h2>
            </div>  
            ...
            <div class="col-md-2 col-6 mb-3">
                <a href="{{ url('admin/gkCa/quizTest') }}"><button class="theme_btn show_modal full_width small_btn">{{'Back'}}</button></a>
            </div>
        </div>
        <div class="white_box">
            <div class="theme_tab">
                ...
                <form name="add-live-test-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-lg-4">
                            <label class="h6"> {{'GK & CA'}} </label>
                        </div>
                        <div class="col-md-2 col-lg-2">
                            <label class="h6 live_test_lable"><b> Duration : </b></label>
                        </div>
                        <div class="col-md-4 col-lg-4">
                            <label class="h6"> {{ $getExam['exam_duration'] }} </label>
                        </div>
                    </div> 
                    <br>

	...
	<div class="container-fluid">
		<div class="row ">
            <div class="col-12 mb-3">
    			<h2 class="title"><span>{{'Gk & Ca'}}</span> > {{'Article & News'}}</h2>
            </div>
            <div class="col-md-4 mb-3">
                <input type="text" id="search_article_news" class="form-control without_border icon_control search_control" placeholder="{{'Search'}}">
            </div>  
            ...
            <div class="col-md-2 col-6 mb-3">
                ...
                @endphp
                @if(!empty($accessPriData['Article_News']) && $accessPriData['Article_News']->add==true || Auth::user()->user_type==0)
                <a href="{{url('/admin/gkCa/addArticleNews')}}"><button class="theme_btn show_modal full_width small_btn">{{'Add New'}}</button></a>
                @endif
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="theme_table">
                    <div class="table-responsive">
                        <table id="article_news_listing" class="display" style="width:100%">
                            <thead>
                                <tr>
                                    <th>{{'Sr. No.'}}</th>
                                    <th>{{'Title'}}</th>

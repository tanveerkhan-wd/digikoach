    ...
    <div class="container-fluid">
        <div class="row ">
            <div class="col-md-6 mb-3">
                <h2 class="title"><a class="ajax_request" data-slug="admin/gkCa/quizTest" href="{{url('/admin/gkCa/quizTest')}}"><span>{{'Gk Ca Quiz Test'}}</span></a>  > <a href="{{url('/admin/gkCa/quizTest/appearedStudents')}}{{'/'.$data['exam_id']}}"><span>{{'Appeared Student List'}}</span></a> > {{'View'}}</h2>
            </div>
            <div class="col-md-4 text-md-right mb-3">
                
            </div>  
            <div class="col-md-2 col-6 mb-3">
                <a href="{{url('/admin/gkCa/quizTest/appearedStudents')}}{{'/'.$data['exam_id']}}"><button class="theme_btn show_modal full_width small_btn">{{'Back'}}</button></a>
            </div>
        </div>

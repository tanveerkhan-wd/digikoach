	...
	<div class="container-fluid">
		<div class="row ">
            <div class="col-12 mb-3">
    			<h2 class="title"><span>{{'Gk & Ca'}}</span> > {{'Quizzes'}}</h2>
            </div>
            <div class="col-md-4 mb-3">
                <input type="text" id="search_quiz_test" class="form-control without_border icon_control search_control" placeholder="{{'Search'}}">
            </div>  
            ...
            <div class="col-md-2 col-6 mb-3">
                ...
                @endphp
                @if(!empty($accessPriData['GK_CA_Quizz']) && $accessPriData['GK_CA_Quizz']->add==true || Auth::user()->user_type==0)
                <a href="{{url('/admin/gkCa/addQuizTest')}}"><button class="theme_btn show_modal full_width small_btn">{{'Add New'}}</button></a>
                @endif
            </div>
        </div>

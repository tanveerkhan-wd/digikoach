...
')
     ...
     */ 
        ...
        {
                        /** @var \App\Common\Settings $instance */
                        return $instance->resolveCache();
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function get($setting_key = null)
        {
                        /** @var \App\Common\Settings $instance */
                        return $instance->get($setting_key);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function has($setting_key)
        {
                        /** @var \App\Common\Settings $instance */
                        return $instance->has($setting_key);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function set($changes, $force = false)
        {
                        /** @var \App\Common\Settings $instance */
                        return $instance->set($changes, $force);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function getThumbImage($image_name, $image_width = 0, $image_height = 0, $crop_image = false)
        {
                        /** @var \App\Common\Utilities $instance */
                        return $instance->getThumbImage($image_name, $image_width, $image_height, $crop_image);
        }
...
namespace  { 
            ...
            class Settings extends \App\Common\Facades\Settings {}
            class Utilities extends \App\Common\Facades\Utilities {}
